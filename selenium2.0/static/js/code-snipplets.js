...
$(document).ready(function() {
    ...
    for (language in languages) {
        $(".highlight-" + language).each(function(){
            ...
            $(this).before("<input type='image' class='toggler toggler-"+language+"' value='"+language+"' src='/static/" +language+ ".png'/>");
            if (!languages[language]) $(this).hide();
            else {
                $(this).prev()[0].src = "/static/highlight-" +language+ ".png";
            }
        });
    }
...
function togglePrefernce() {
    $(this).click(function(){
        if (this.src.indexOf("highlight") != -1) {
            ...
            $(".toggler-" + this.value).each(function(){
                if (this.src.indexOf("highlight")==-1) this.src = this.src.replace("static/", "static/highlight-");
                $(this).next().show();
            });
    ...
    if (languages[this.value]) this.src = "/static/highlight-" +this.value+ ".png";
}
